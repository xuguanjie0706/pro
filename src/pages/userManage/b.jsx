  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (record, item) => (
          <span>
            <Button type="link" onClick={this.showDetail.bind(this, item)}>
              查看
            </Button>
            <Button type="link" onClick={this.showUpdate.bind(this, item)}>
              编辑
            </Button>
          </span>
        ),
    ...
    return (
      <div>
          ...
          >
            <div span={24} label="领取时间：">
              <DateFilter
                ...
                defaultValue={['', '']}
                onChange={this.onReceieveChange.bind(this)}
              />
            </div>
            <div span={6} label="用户：">
              <UserSelect onChange={this.userSearchChange.bind(this)} />
            </div>
            ...
            <div span={24}>
              <Button onClick={this.reload.bind(this)} type="primary">
                筛选
              </Button>
            </div>
          </SearchForm>
        ...
        <Dialog
          ...
          title="拥有权益"
          onClose={this.hideDetail.bind(this)}
          footer={[
            <Button key="back" onClick={this.hideDetail.bind(this)}>
              取消
            </Button>,
            this.state.step === 1 ? (
              <Button
            ...
            <div style={{ display: 'block', width: '100%' }}>
              <div style={{ marginBottom: 20 }}>
                ...
                <Select
                  ...
                  onChange={e => {
                    const obj = this.state.pkgList.find(
                      item => item.pkgId === e,
                    );
                    this.setState({
                      pkgId: e,
        ...
        <Dialog
          ...
          footer={[
            ...
            <Button
              key="submit"
              onClick={this.editConfirm.bind(this)}
              ...
              <div style={{ display: 'inline-block', width: 350 }}>
                ...
                {this.state.tagSelectVisiable ? (
                  <Select
                    ...
                    onChange={this.addTagChange.bind(this)}
                    mode="tags"
                  >
                    ...
                    <span
                      ...
                      onClick={this.showAddTag.bind(this)}
                    >
                      添加标签
                    </span>
                  )}
        ...
        <Dialog
          ...
          footer={[
            ...
            <Button
              key="1"
              type="primary"
              onClick={this.newGroupSubmit.bind(this)}
            >
              确认
            </Button>,
          ]}
